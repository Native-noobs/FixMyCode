...
const ModalForTask: FC<LessonModalPros> = ({ setIsOpen, id }) => {
  ...
  const [initializeCode, setInitializeCode] = useState<any>();
  ...
  const md: MarkdownResult = processor.processSync(description)
  ...
  return (
    <div className="absolute w-full h-dvh flex items-center justify-center">
      ...
      >
        <div className="overflow-auto my-5 scroll px-3">
          ...
          <div className="mt-10 flex justify-between w-full gap-6">
            ...
            <div className="w-2/4 flex flex-col gap-3">
              {testCases.map((e, i) => {
                return (
                  <div key={i}>
                    <p className="text-xl">{i + 1} - Test case</p>
