    ...
    return (
        <>
            <div className="absolute w-full h-dvh top-0 left-0 flex items-end justify-center md:items-center">
                <div
                    className="bg-slate-900 max-w-[600px] w-full p-10 rounded-xl flex mx-5
                ...
                >
                    ...
                    <div className="flex flex-col gap-3 w-full md:text-start text-center">
                        ...
                        <div className="flex gap-3 flex-col md:flex-row w-full">
                            <button
                                className="md:w-20 w-full bg-red-500 hover:bg-red-600 active:bg-red-300 rounded-xl h-10 duration-150"
                            ...
                            <button
                                ...
                                className="md:w-20 w-full border-2 hover:bg-slate-700 rounded-xl active:bg-slate-500 h-10 duration-150"
                            >
            ...
            <div
                onClick={props.onCancel}
                className="w-full h-dvh absolute backdrop-blur-sm"
            ></div>
        </>
    );
};
